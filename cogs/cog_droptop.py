...
class InfoCommands(commands.Cog, name='Info'):
    ...
    async def info(self, ctx, arg=None):
        ...
        generic = discord.Embed(title='Droptop Four',
                                color=discord.Color.from_rgb(75, 215, 100))
        generic.set_author(name="Created by Cariboudjan", url="https://blacksquare88.wixsite.com/droptop4",
                           icon_url='https://cdn.discordapp.com/avatars/584542239900827665/8d070369e6169444ad45c479ef0eec9a.png?size=1024')
        generic.set_thumbnail(
            url='https://cdn.discordapp.com/icons/800124057923485728/7e8f7f08dce1d220711ee2488d497c8f.webp?size=1024')
        ...
        generic.add_field(
            name="Basic Version", value='The `Basic` version has:\n - 7 home bottons icons\n - 6 fully-customizable toolbars\n - 4 themes to choose from', inline=True)
        generic.add_field(name='Supporter Version',
                          value='The `Supporter` version has:\n - 300 home buttons icons\n - 12 fully-customizable toolbars\n - 22 themes to choose from', inline=True)
        generic.set_footer(text="To see further infos on one of the two versions type `{0}info basic` or `{0}info supporter` or click the buttons below".format(
            self.bot.command_prefix))

        base = discord.Embed(title='Droptop Four Basic Version',
                             color=discord.Color.from_rgb(75, 215, 100))
        base.set_author(name="Created by Cariboudjan", url="https://blacksquare88.wixsite.com/droptop4",
                        icon_url='https://cdn.discordapp.com/avatars/584542239900827665/8d070369e6169444ad45c479ef0eec9a.png?size=1024')
        base.set_thumbnail(
            url='https://cdn.discordapp.com/icons/800124057923485728/7e8f7f08dce1d220711ee2488d497c8f.webp?size=1024')
        base.add_field(
            name="What is it?", value="This is the Basic and free version of droptop.", inline=False)
        base.add_field(
            name="Perks", value='The `Basic` version has:\n - 7 home bottons icons\n - 6 fully-customizable toolbars\n - 4 themes to choose from', inline=False)
        ...
        supp = discord.Embed(title='Droptop Four Supporter Version',
                             color=discord.Color.from_rgb(75, 215, 100))
        supp.set_author(name="Created by Cariboudjan", url="https://blacksquare88.wixsite.com/droptop4",
                        icon_url='https://cdn.discordapp.com/avatars/584542239900827665/8d070369e6169444ad45c479ef0eec9a.png?size=1024')
        supp.set_thumbnail(
            url='https://cdn.discordapp.com/icons/800124057923485728/7e8f7f08dce1d220711ee2488d497c8f.webp?size=1024')
        supp.add_field(
            name="What is it?", value="This is the Supporter version of droptop.\nTo download it you can pay what you want through Gumroad.", inline=False)
        supp.add_field(
            name='Perks', value='The `Supporter` version has:\n - 300 home buttons icons\n - 12 fully-customizable toolbars\n - 22 themes to choose from', inline=False)
        ...
        if arg == None:
            send1 = await ctx.send(embed=generic, components=[[Button(label='Generic Info', id='generic', style=2, disabled=True), Button(label='Base Version Info', id="base", style=1), Button(label='Supporter Version Info', id="supp", style=3)], Button(label='Site', style=5, url='https://www.droptopfour.com')])
        ...
        if arg in basic:
            send2 = await ctx.send(embed=base, components=[[Button(label='Generic Info', id='generic', style=2), Button(label='Base Version Info', id="base", style=1, disabled=True), Button(label='Supporter Version Info', id="supp", style=3)], Button(label='Site', style=5, url='https://www.droptopfour.com')])
        ...
        if arg in supporter:
            send3 = await ctx.send(embed=supp, components=[[Button(label='Generic Info', id='generic', style=2, ), Button(label='Base Version Info', id="base", style=1), Button(label='Supporter Version Info', id="supp", style=3, disabled=True)], Button(label='Site', style=5, url='https://www.droptopfour.com')])
    ...
    async def download(self, ctx):
        down = discord.Embed(title='Droptop Four Downloads',
                             color=discord.Color.from_rgb(75, 215, 100))
        down.set_author(name="Created by Cariboudjan", url="https://blacksquare88.wixsite.com/droptop4",
                        icon_url='https://cdn.discordapp.com/avatars/584542239900827665/8d070369e6169444ad45c479ef0eec9a.png?size=1024')
        down.set_thumbnail(
            url='https://cdn.discordapp.com/icons/800124057923485728/7e8f7f08dce1d220711ee2488d497c8f.webp?size=1024')
        down.add_field(name="Where to download?",
                       value="The Droptop **Base** version can be downloaded on the DeviantArt page of Droptop *[https://www.deviantart.com/cariboudjan/art/droptop-four-762812007]* or by being redirected to it on the Droptop Official Site *[https://blacksquare88.wixsite.com/droptop4]* (for help about the Base version type `{0}info base`)\n\nThe Droptop **Supporter** version can be downloaded after paying what you want on Gumroad *[https://gumroad.com/l/droptop]* (for help about the Supporter version type `{0}info supporter`)".format(self.bot.command_prefix), inline=False)
    ...
    async def faq(self, ctx):
        faq = discord.Embed(title='Droptop Four F.A.Q.',
                            color=discord.Color.from_rgb(75, 215, 100))

        faq.add_field(name="Where do I find the FAQs?",
                      value="You can find the FAQ at https://blacksquare88.wixsite.com/droptop4/faq.", inline=False)
    ...
    async def beta(self, ctx, member: discord.Member = None):
        ...
        embed = discord.Embed(
            title='Beta Program', description='Enroll now to the Droptop Four Beta Program! The procedure is quite easy, just follow the guidelines below!', color=0x409bda)
        embed.set_author(name="Droptop Four", url="https://blacksquare88.wixsite.com/droptop4",
                         icon_url=self.bot.user.avatar_url)
        embed.add_field(name='How', value='To enroll you have to have a Gmail account and send me the command `{0}beta-apply \"<name>\" \"<Gmail address>\"`'.format(
            self.bot.command_prefix), inline=False)
        embed.add_field(
            name='IMPORTANT!!', value='You have to follow the syntax of the command or your subscription wont be guaranteed.\n**REMEMBER TO USE QUOTATION MARKS**', inline=False)
        embed.add_field(name='Example', value='`{0}beta-apply \"John Doe\" \"john.doe@gmail.com\"`'.format(
            self.bot.command_prefix), inline=False)
            ...
            if role in member.roles:
                ...
                if re.search("@gmail.com$", email):
                    ...
                    post = {"DateTime": now.strftime(
                        "%d/%m/%Y %H:%M:%S"), "UserID": ctx.author.id, "sID": ctx.author.display_name, "Name": name, "Gmail": gmail}

                    embed = discord.Embed(
                        title='Beta Program Enrollment', description='Your informations are being sent...', color=0x409bda)
                    embed.add_field(name='Your Informations:', value='```\nUserID: {0}\nsID: {1}\nName: {2}\nGmail: {3}\nDateTime: {4} UTC\n```'.format(
                        (ctx.author.id), (ctx.author.display_name), (name), (gmail), (now.strftime("%d/%m/%Y %H:%M:%S"))), inline=False)
                    await ctx.send(embed=embed)

                    collection_d.insert_one(post)

                    embed2 = discord.Embed(
                        title='Beta Program Enrollment', description='Registration of <@{0}>'.format(ctx.author.id), color=0x409bda)
    ...
    async def _bapply_error(self, ctx, error):
        if isinstance(error, commands.PrivateMessageOnly):
            embed = discord.Embed(title='This command can be used only in PMs!',
                                  description='Since you have to send personal informations, you have to use this command in a PM (Private Message) with the bot.', color=0xFF2E00)
