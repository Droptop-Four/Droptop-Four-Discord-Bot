...
class NewVersion(discord.ui.Modal, title="New Version"):
	...
	async def on_submit(self, interaction: discord.Interaction):
		...
		if version_validator(self.version.value):
			...
			download_button = discord.ui.Button(style=style, label="Download", url=f"https://github.com/Droptop-Four/Droptop-Four/releases/download/v{self.version.value}.{self.miniversion.value}/Droptop_Update.rmskin")
			view.add_item(item=download_button)
	
			embed = discord.Embed(title=f"📢 Droptop Four {self.version.value}.{self.miniversion.value}", url=f"https://github.com/Droptop-Four/Droptop-Four/releases/download/v{self.version.value}.{self.miniversion.value}/Droptop_Update.rmskin", color=0x2F3136)
			...
			embed.add_field(name="Download", value=f"⬇️ Download:\nhttps://github.com/Droptop-Four/Droptop-Four/releases/tag/v{self.version.value}.{self.miniversion.value}", inline=False)
